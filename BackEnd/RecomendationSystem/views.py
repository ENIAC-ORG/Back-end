...
class PatientFormAPIView(APIView):
    def get(self, request):
        ...
        """
        questions = [
            {"id": 1, "text": "چه علائمی دارید؟", "type": "text"},
            {"id": 2, "text": "سطح استرس روزانه خود را از 1 تا 10 ارزیابی کنید.", "type": "text"},
            {"id": 3, "text": "سطح انرژی خود را چگونه ارزیابی می‌کنید؟", "type": "text"},
            {"id": 4, "text": "آیا شما خود را مذهبی می‌دانید؟", "type": "text"},
            {"id": 5, "text": "ترجیح شما برای جنسیت درمانگر چیست؟", "type": "text"},
            {"id": 6, "text": "ترجیح شما برای نوع جلسات چیست؟", "type": "text"},
            {"id": 7, "text": "مدت زمان درمان مورد انتظار شما چیست؟", "type": "text"},
            ...
            {"id": 10, "text": "آخرین باری که به خودکشی فکر کردید، چه زمانی بود؟", "type": "text"},
            {"id": 11, "text": "آیا مشکلات جسمی خاصی دارید که روی روان شما تأثیر می‌گذارد؟", "type": "text"},
            {"id": 12, "text": "به طور متوسط چند ساعت در شبانه‌روز می‌خوابید؟", "type": "text"},
            {"id": 13, "text": "آیا به طور منظم در فعالیت‌های اجتماعی یا گروهی شرکت می‌کنید؟", "type": "text"},
    ...
    def post(self, request):
        ...
        for key, value in request.data.items():
            if key in ["13"]:  # فیلدهای بولین
                processed_data[key] = value == "بله"
            elif key in ["2", "12"]:  # فیلدهای عددی
...
class PsychologistFormAPIView(APIView):
    def get(self, request):
        ...
        """
        questions = [
            {"id": 1, "text": "تخصص‌های شما چیست؟", "type": "text"},
            {"id": 2, "text": "چه روش‌های درمانی را استفاده می‌کنید؟", "type": "text"},
            {"id": 3, "text": "با کدام گروه‌های سنی کار می‌کنید؟", "type": "text"},
            {"id": 4, "text": "چه نوع جلساتی را ارائه می‌دهید؟", "type": "text"},
            {"id": 5, "text": "آیا شما خود را مذهبی می‌دانید؟", "type": "text"},
            {"id": 6, "text": "جنسیت شما چیست؟", "type": "text"},
            {"id": 7, "text": "چند سال سابقه کاری دارید؟", "type": "text"},
            {"id": 8, "text": "حداکثر تعداد جلسات در هفته که می‌توانید ارائه دهید؟", "type": "text"},
            {"id": 9, "text": "آیا تجربه کار با بیمارانی که مشکلات جسمی دارند را دارید؟", "type": "text"},
            {"id": 10, "text": "آیا در مدیریت بحران (مانند بیماران با خطر خودکشی) تجربه دارید؟", "type": "text"},
            {"id": 11, "text": "آیا تمایل دارید با بیماران مذهبی یا غیرمذهبی کار کنید؟", "type": "text"},
            {"id": 12, "text": "آیا ترجیح خاصی برای جنسیت بیمار دارید؟", "type": "text"},
